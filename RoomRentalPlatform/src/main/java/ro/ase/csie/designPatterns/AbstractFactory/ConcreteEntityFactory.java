...
public class ConcreteEntityFactory implements EntityFactory {
    ...
    @Override
    public Room createRoom(int id, String name, int floor, String location, int capacity, String type, boolean isAvailable, boolean hasProjector, boolean hasSmartBoard, double pricePerDay) {
